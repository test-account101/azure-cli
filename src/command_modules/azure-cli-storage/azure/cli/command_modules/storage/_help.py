...
examples:
  - name: List network rules. (crafted)
...
examples:
  - name: Update the properties of a storage account. (crafted)
...
examples:
  - name: Copies a blob asynchronously. Use `az storage blob show` to check the status of the blobs. (crafted)
    text: az storage blob copy start --destination-blob {destination-blob} --destination-container {destination-container} --source-blob {source-blob} --source-container {source-container}
    crafted: true
"""
...
examples:
  - name: Copy multiple blobs or files to a blob container. Use `az storage blob show` to check the status of the blobs. (crafted)
    text: az storage blob copy start-batch --account-name MyAccount --destination-container {destination-container} --source-account-name MySourceAccount --source-container {source-container}
    crafted: true
"""
...
examples:
  - name: Check for the existence of a blob in a container. (crafted)
    text: az storage blob exists --account-key {account-key} --account-name MyAccount --container-name MyContainer --name MyBlob
    crafted: true
"""
...
examples:
  - name: Update storage blob service properties. (crafted)
...
examples:
  - name: Set the block or page tiers on the blob. (crafted)
    text: az storage blob set-tier --account-key {account-key} --account-name MyAccount --container-name MyContainer --name MyBlob --tier P10
    crafted: true
"""
...
examples:
  - name: Create the url to access a blob. (crafted)
...
examples:
  - name: Marks the specified container for deletion. (crafted)
    text: az storage container delete --account-key {account-key} --account-name MyAccount --name MyContainer
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage container. (crafted)
    text: az storage container exists --account-key {account-key} --account-name MyAccount --name MyContainer
    crafted: true
"""
...
examples:
  - name: List containers in a storage account. (commonly used with --output)
    text: az storage container list --account-name MyAccount
    crafted: true
"""
...
parameters:
  - name: --services
    short-summary: >
        ...
        (q)ueue, (t)able. Can be combined.
examples:
  - name: List all CORS rules for a storage account. (crafted)
    text: az storage cors list --connection-string {connection-string}
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage directory. (crafted)
    text: az storage directory exists --account-key {account-key} --account-name MyAccount --name MyDirectory --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Insert an entity into a table. (crafted)
    text: az storage entity insert --account-name MyAccount --entity {entity} --if-exists fail --sas-token {sas-token} --table-name MyTable
    crafted: true
"""
...
examples:
  - name: List entities which satisfy a query. (crafted)
    text: az storage entity query --account-key {account-key} --account-name MyAccount --filter {filter} --select {select} --table-name MyTable
    crafted: true
"""
...
examples:
  - name: Delete files from an Azure Storage File Share. (crafted)
    text: az storage file delete-batch --account-key {account-key} --account-name MyAccount --pattern {pattern} --source {source}
    crafted: true
"""
...
examples:
  - name: Download files from an Azure Storage File Share to a local directory in a batch operation. (crafted)
    text: az storage file download-batch --account-key {account-key} --account-name MyAccount --destination {destination} --pattern {pattern} --source {source}
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file. (commonly used with --output)
    text: az storage file exists --connection-string {connection-string}   --path {path} --share-name MyShare --timeout {timeout}
    crafted: true
"""
...
examples:
  - name: List files and directories in a share. (crafted)
    text: az storage file list --connection-string {connection-string} --share-name MyShare
    crafted: true
"""
...
parameters:
  ...
  - name: --validate-content
    ...
    long-summary: >
        ...
        This is mostly valuable for detecting bitflips during transfer if using HTTP instead of HTTPS. This hash is not stored.
examples:
  - name: Upload files from a local directory to an Azure Storage File Share in a batch operation. (crafted)
    text: az storage file upload-batch --account-key {account-key} --account-name MyAccount --destination {destination} --source {source}
    crafted: true
"""
...
examples:
  - name: Create the url to access a file. (crafted)
    text: az storage file url --connection-string {connection-string} --path {path} --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Show metrics settings for a storage account. (crafted)
    text: az storage metrics show --account-name MyAccount --services {services} --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update metrics settings for a storage account. (crafted)
    text: az storage metrics update --account-name MyAccount --api true --hour true --minute true --retention  --services {services}
    crafted: true
"""
...
examples:
  - name: List queues in a storage account. (commonly used with --query)
    text: az storage queue list --account-name MyAccount   --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Creates a new share under the specified account. (crafted)
    text: az storage share create --connection-string {connection-string} --name MyFileShare --quota {quota} --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file share. (crafted)
    text: az storage share exists --account-key {account-key} --account-name MyAccount --connection-string {connection-string} --name MyFileShare
    crafted: true
"""
...
examples:
  - name: List the file shares in a storage account. (commonly used with --output)
    text: az storage share list --account-name MyAccount
    crafted: true
"""
...
examples:
  - name: List tables in a storage account. (commonly used with --query)
    text: az storage table list --account-name MyAccount   --subscription MySubscription
    crafted: true
"""
