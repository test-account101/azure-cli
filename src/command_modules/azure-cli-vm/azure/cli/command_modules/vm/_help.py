...
examples:
  - name: Delete a managed disk. (crafted)
...
examples:
  - name: Update a managed disk. (crafted)
    text: az disk update --name MyManagedDisk --resource-group MyResourceGroup --size-gb {size-gb}
    crafted: true
"""
...
examples:
  - name: List custom VM images. (crafted)
    text: az image list --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: list share image galleries. (crafted)
    text: az sig list --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Grant read access to a snapshot. (commonly used with --output and --query)
    text: az snapshot grant-access --duration-in-seconds {duration-in-seconds} --name MySnapshot     --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List snapshots. (commonly used with --output)
    text: az snapshot list
    crafted: true
"""
...
examples:
  - name: Revoke read access to a snapshot. (commonly used with --output)
...
examples:
  - name: Update a snapshot. (crafted)
    text: az snapshot update --name MySnapshot --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show encryption status. (crafted)
...
examples:
  - name: display VM's managed identity info. (crafted)
...
examples:
  - name: Accept Azure Marketplace term so that the image can be used to create VMs (crafted)
...
examples:
  - name: Delete VMs within a VMSS. (crafted)
    text: az vmss delete-instances --instance-ids {instance-ids} --name MyScaleSet --no-wait  --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: View an instance of a VMSS. (crafted)
...
examples:
  - name: List VMSS. (commonly used with --output and --query)
    text: az vmss list
    crafted: true
  - name: Gets a list of all virtual machines in a VM scale sets. (commonly used with --output and --query)
    text: az vmss list-instances --name MyScaleSet     --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the IP address and port number used to connect to individual VM instances within a set. (commonly used with --output)
...
examples:
  - name: List public IP addresses of VM instances within a set. (commonly used with --output and --query)
...
examples:
  - name: Restart VMs within a VMSS. (crafted)
...
examples:
  - name: Change the number of VMs within a VMSS. (crafted)
    text: az vmss scale --name MyScaleSet --new-capacity {new-capacity} --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details on VMs within a VMSS. (commonly used with --output and --query)
...
examples:
  - name: Update a VMSS. (crafted)
    text: az vmss update --name MyScaleSet --resource-group MyResourceGroup --set {set}
    crafted: true
"""
...
examples:
  - name: Upgrade VMs within a VMSS. (crafted)
    text: az vmss update-instances --instance-ids {instance-ids} --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
